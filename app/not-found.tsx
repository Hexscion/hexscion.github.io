...
export default function NotFound() {
  return (
    <div className="py-28 px-6 max-w-200 mx-auto min-h-[70vh] flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl sm:text-5xl font-bold font-sans text-dark mb-4">Oh no!!</h1>
      <p className="text-lg sm:text-xl text-dark/75 max-w-122.5 mx-auto leading-relaxed mb-8">
